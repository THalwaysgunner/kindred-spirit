            ...
            <div className="flex-1 p-8 space-y-8 overflow-y-auto no-scrollbar">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div
                     ...
                     className={`p-5 rounded-2xl relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-transform
                     ${activeFeature === 'roadmap' ? 'bg-gradient-to-br from-teal-600 to-teal-800 ring-2 ring-white/20' : 'bg-gradient-to-br from-[#0d9488] to-[#0f766e]'}
                  `}
                  >
                  ...
                  <div
                     ...
                     className={`p-5 rounded-2xl relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-transform
                     ${activeFeature === 'skills' ? 'bg-gradient-to-br from-purple-600 to-purple-800 ring-2 ring-white/20' : 'bg-gradient-to-br from-[#7c3aed] to-[#6d28d9]'}
                  `}
                  >
                  ...
                  <div
                     ...
                     className={`p-5 rounded-2xl relative overflow-hidden group cursor-pointer hover:scale-[1.02] transition-transform
                     ${activeFeature === 'progress' ? 'bg-gradient-to-br from-sky-600 to-sky-800 ring-2 ring-white/20' : 'bg-gradient-to-br from-[#0284c7] to-[#0369a1]'}
                  `}
                  >
                     <div className="relative z-10 h-32 flex flex-col justify-between">
                        <div>
               ...
               {activeFeature === 'overview' && selectedApp && (
                  <section className="animate-in fade-in slide-in-from-top-4 duration-300">
                     <div className="bg-white dark:bg-[#1a1a1a] rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-sm">
                        ...
                        {/* Inner Tabs - Matching ApplicationsList tab style */}
               ...
               {activeFeature === 'roadmap' && (
                  <section className="animate-in fade-in slide-in-from-top-4 duration-300">
                     <div className="bg-white dark:bg-[#1a1a1a] rounded-xl border border-slate-200 dark:border-slate-700 p-8">
